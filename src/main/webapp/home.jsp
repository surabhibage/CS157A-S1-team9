...
<% if (request.getParameter("hold") != null) { %>
    <div style="padding: 10px; margin-bottom: 20px; border-radius: 4px; background-color: #d4edda; color: #155724;">Hold requested successfully! Please wait for confirmation</div>
<% } %>
<% if (request.getParameter("error") != null) { 
    ...
    if ("already_on_hold".equals(errorMsg)) displayMsg = "There is an active hold request for this book.";
%>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <% } else if ("Borrower".equals(role) && available <= 0) { %>
                	<a href="RequestHoldServlet?bookId=<%= currentId %>" class="btn">Request Hold</a>
                <% } %>
            </td>
        </tr>
        <%
