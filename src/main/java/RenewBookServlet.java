...
public class RenewBookServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      String loanDetailsSql =
          "SELECT l.Renewal_Count, h.Book_ID FROM Loans l "
      ...
      String updateSql =
          "UPDATE Loans SET Due_Date = DATE_ADD(Due_Date, INTERVAL 14 DAY), Renewal_Count ="
              + " Renewal_Count + 1 WHERE Loan_ID = ?";
